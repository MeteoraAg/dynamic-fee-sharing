...
pub mod seeds {
    ...
    pub const WHITELISTED_ACTION_PREFIX: &[u8] = b"whitelisted_action";
}
...
/// to be used with fund_by_claiming_fee with FeeVault
pub static STATIC_WHITELISTED_ACTIONS: [(Pubkey, &[u8], usize); 7] = [
    // damm v2
    (
        damm_v2::ID,
