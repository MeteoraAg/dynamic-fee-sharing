...
#[event_cpi]
#[derive(Accounts)]
pub struct WithdrawDbcCreatorSurplusCtx<'info> {
    #[account(mut)]
...
pub fn handle_withdraw_dbc_creator_surplus(
    ctx: Context<WithdrawDbcCreatorSurplusCtx>,
) -> Result<()> {
    ...
    dynamic_bonding_curve::cpi::creator_withdraw_surplus(CpiContext::new(
