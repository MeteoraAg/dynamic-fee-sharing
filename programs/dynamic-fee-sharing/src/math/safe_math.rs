...
pub trait SafeMath<T>: Sized {
    fn safe_add(self, rhs: Self) -> Result<Self, FeeVaultError>;
    fn safe_mul(self, rhs: Self) -> Result<Self, FeeVaultError>;
    fn safe_div(self, rhs: Self) -> Result<Self, FeeVaultError>;
    fn safe_rem(self, rhs: Self) -> Result<Self, FeeVaultError>;
    fn safe_sub(self, rhs: Self) -> Result<Self, FeeVaultError>;
    fn safe_shl(self, offset: T) -> Result<Self, FeeVaultError>;
    fn safe_shr(self, offset: T) -> Result<Self, FeeVaultError>;
}
...
macro_rules! checked_impl {
    ($t:ty, $offset:ty) => {
        impl SafeMath<$offset> for $t {
            #[inline(always)]
            fn safe_add(self, v: $t) -> Result<$t, FeeVaultError> {
                match self.checked_add(v) {
                    Some(result) => Ok(result),
                    None => {
                        let caller = Location::caller();
                        msg!("Math error thrown at {}:{}", caller.file(), caller.line());
                        Err(FeeVaultError::MathOverflow)
                    }
                }
            }

            #[inline(always)]
            fn safe_sub(self, v: $t) -> Result<$t, FeeVaultError> {
            ...
            #[inline(always)]
            fn safe_mul(self, v: $t) -> Result<$t, FeeVaultError> {
            ...
            #[inline(always)]
            fn safe_div(self, v: $t) -> Result<$t, FeeVaultError> {
            ...
            #[inline(always)]
            fn safe_rem(self, v: $t) -> Result<$t, FeeVaultError> {
            ...
            #[inline(always)]
            fn safe_shl(self, v: $offset) -> Result<$t, FeeVaultError> {
            ...
            #[inline(always)]
            fn safe_shr(self, v: $offset) -> Result<$t, FeeVaultError> {
